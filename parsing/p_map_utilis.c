...
// Check if the starting character of the row is 1 or 0. 
// returns the index of that characters 
...
// Check if the map ends with spaces or special characters like tabs, carriage returns etc.
...
int	check_map_is_at_the_end(t_imap *map)
{
 ...
 // Checks for the validty of map elements, for example, plyers direction map data etc
...
// Skips over spaces , tabs, new line characters, and handle cases where the datas begins
...
//If those functions above are the muscles, then this is the brain of all of them. 
